package icomac.controller;

import icomac.enums.OperatorFriendRequestTypeEnum;
import icomac.enums.SearchFriendsStatusEnum;
import icomac.pojo.Users;
import icomac.pojo.bo.UsersBO;
import icomac.pojo.vo.MyFriendsVO;
import icomac.pojo.vo.UsersVO;
import icomac.service.UserService;
import icomac.utils.FastDFSClient;
import icomac.utils.FileUtils;
import icomac.utils.IMoocJSONResult;
import icomac.utils.MD5Utils;
...
public class UserController {
    ...
    public IMoocJSONResult uploadFaceBase64(@RequestBody UsersBO userBO) throws Exception{
        ...
        //获取前端传过来的base64字符串，然和转换为文件对象再上传
    ...
    public IMoocJSONResult searchUser(String myUserId, String friendUsername)
        ...
        //前置条件 - 1. 搜索的朋友已经是你的朋友，返回[该用户已经是你的好友]
    ...
    */
    ...
    public IMoocJSONResult getUnReadMsgList(String acceptUserId){
        ...
        // 查询列表
        List<icomac.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
